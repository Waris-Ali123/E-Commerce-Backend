...
from app.products.schemas import ProductOut,ProductOutWithIsDeleted
...
class OrderItemOut(BaseModel):
    ...
    product : ProductOutWithIsDeleted = Field(... ,description="Product Complete detials")
...
class OrderOutBase(BaseModel):
    ...
    total_amount : float = Field(...,description="This is total amount of order")
